...
#
# Ejecución remota:
#   curl -sL https://raw.githubusercontent.com/nipegun/df-scripts/refs/heads/main/DFIRWindows/Artefactos-MFT-Parsear.sh | bash -s [CarpetaConLaMFTOriginal] [CarpetaDondeGuardarLosParseos]
#
